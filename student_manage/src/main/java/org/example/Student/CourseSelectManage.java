...
public class CourseSelectManage extends JFrame{
    JLabel jLabel1 = new JLabel("选课管理");
    ResultSet rs = null;
    ...
    public CourseSelectManage(String studentID) {
        try {
    ...
    private void jbInit() throws Exception {
        ...
        sql = "select studentID,studentName,courseName,teacherName from tb_course_selection where studentID='" + studentID +"'";
        try {
