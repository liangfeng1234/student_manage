...
public class MyCourseManage extends JFrame{
    ...
    public MyCourseManage(String teacherID) {
        try {
    ...
    private void jbInit() throws Exception {
        ...
        sql = "select * from tb_course where teacherName = " +
                "(select teacherName from tb_teacher where teacherID = '" + teacherID + "')";
        try {
