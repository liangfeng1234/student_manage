...
public class ManageGradePane extends JPanel{
    JLabel jLabel1 = new JLabel("学生成绩管理");
    ResultSet rs = null;
    ...
    public ManageGradePane(JPanel panel, String teacherID) {
        try {
    ...
    private void jbInit(JPanel panel) throws Exception {
        ...
        //设置JTable的列名
        String[] headers={"课程号","课程名", "学生学号", "学生姓名","学期","成绩"};
